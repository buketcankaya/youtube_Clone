    ...
    <>
      ...
      <div className="flex justify-between items-center p-3">
        <div className="flex items-center gap-4">
          ...
          <button className="bg-white h-9 rounded-full text-black px-3 transition-all hover:bg-gray-300 ">
            Abone Ol
          </button>
        </div>
        {/*Sağ Taraf Like ve Dislike button kısmı*/}
        <div className="flex items-center rounded-full bg-gray-600 px-6 py-1">
      ...
      <div className="bg-gray-800 mt-2 p-2 cursor-pointer hover:bg-gray-500 rounded">
